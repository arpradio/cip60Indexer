...
1. **Core Indexer**: Connects to Cardano network via Ogmios, processes blocks, and extracts music token metadata- node connection is implied!  _(For full solution, we recommend their Docker container:[cardano-node-ogmios](https://hub.docker.com/r/cardanosolutions/cardano-node-ogmios))_
